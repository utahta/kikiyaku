...
- **Provisional translation** (optional, off by default; one-direction modes, OpenAI-compatible backend) — a long utterance is translated sentence by sentence as it is spoken, shown in a pale style and replaced by the final translation when the utterance ends.
